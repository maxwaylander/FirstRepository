    ...
    <div class="box">
          <section class="flex">
            <div class="one"> <img src="./images/cover.jpg" width="100" height="150" alt="Постер черного отряда">
                <p>Тьма сражается с тьмой, а Черный Отряд кочует из страны в страну и нанимается к тем, кто готов платить — хоть за доблестную битву, хоть за кровавую расправу. В целом мире не сыщется равных этим суровым, закаленным воинам, привыкшим свои сомнения хоронить вместе со своими павшими братьями.</p>
            </div>
            <div class="two"> <img src="./images/tower.jpg" width="100" height="150" alt="Постер темной башни"> <p> Роланд Дискейн – последний представитель древнего ордена стрелков. Вместе с верными сторонниками он совершает поход по постапокалиптической земле. Его цель – дойти до центра всех миров – Темной Башни. Если ему удастся добраться до ее вершины, он сможет понять, кто управляет всем и восстановить равновесие. На пути к вершине герой встречает множество препятствий. Роланд и его спутники посещают другие миры и временные эпохи. Перед ними предстает Нью-Йорк 20 века и Америка старого Запада. Каждый новый мир открывает им завесу тайны. Как долго будет длиться путешествие и удастся ли Роланду встретится с Мирозданием? </p>
            </div>
            <div class="three"> <img src="./images/blood.jpg" width="100" height="150" alt="Постер Блада"> <p>Жизнь была несправедлива к ирландскому врачу Питеру Бладу. За оказание помощи раненому мятежнику его ссылают на остров Барбадос, где продают в рабство на плантации. Однако судьба изменчива… Совершив побег, он присоединяется к пиратам и начинает новую жизнь, опасную и полную приключений. Имя капитана Блада наводит ужас на испанцев, а власти объявили на него охоту. Он захватывает испанские колонии и корабли, спасает английских заложников и сражается на дуэлях. Французы мечтают нанять его на службу, а менее успешные «джентльмены удачи» – избавиться от опасного конкурента. Но, став легендой, сможет ли он остаться прежним человеком и заслужить любовь прекрасной Арабеллы Бишоп?</p> </div>
        ...
        <section class="grid">
            <div class="five"> <img src="./images/Fight_club.jpg" width="100" height="150" alt="Постер бойцовского клуба"> <p>Первое правило Бойцовского клуба: не упоминать о Бойцовском клубе.</p> </div>
            <div class="six"> <img src="./images/snatch.jpg" width="100" height="150" alt="Постер большой куш"> <p> Что я знаю о бриллиантах? Вроде бы их из Антверпена привозят, так?  </p> </div>
            <div class="seven"> <img src="./images/Gentle.jpg" width="100" height="150" alt="Постер джентльмены"> <p> Большие деньги - большие проблемы. </p> </div>
            <div class="eight"> <img src="./images/pulpfctn.jpg" width="100" height="150" alt="Постер криминальное чтиво"> <p>— Чей это мотоцикл? — Это чоппер, детка. — Чей это чоппер? — Зеда. — Кто такой Зед? — А Зед сдох, детка. Зед сдох. </p> </div>
        </section>
        </div>
    </div>
</main>
